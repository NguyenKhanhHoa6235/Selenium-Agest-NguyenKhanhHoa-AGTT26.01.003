...
//			"SBC", "510000"
//        );
//        Assert.assertTrue(ticketPrice.isAtTicketPricePage());
//        Assert.assertEquals(actualPriceMap, expectedPriceMap);
//    }
    ...
    public void TC015() {
        ...
        Assert.assertEquals(actualArriveStation, expectedArrive, "Result Verify 1: Book ticket form shows incorrect Arrive Station"); 
	    ...
	    Assert.assertEquals(actualMsg, expectedMsg, "Result Verify 2: Message Ticket Booked Page is not displayed as expected");
	    assertTrue(Utilities.isRowExistInTable(tableTicketBooked, expectedTableTicketBooked), "Ticket information does not match expected data");
    }
}
